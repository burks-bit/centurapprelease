        ...
        <div>
            ...
            <Segment basic textAlign='center' style={{ height: '100vh' }}>
                <Grid verticalAlign='middle'>
                    <Grid.Row>
                        <Grid.Column>
                            {/* <Image src={apiUrl+`web_images/webpage.jpg`} size='' centered style={{height: '620px'}} /> */}
                            ...
                            <Image
                                src={apiUrl + `web_images/webpage.jpg`}
                                size=''
                                centered
                                className=''
                                style={{
            ...
            <Segment basic textAlign='center' style={{ background: '#f9f9f9' }}>
                <Grid container stackable verticalAlign='middle'>
                    <Grid.Row>
                        ...
                        <Grid.Column width={8}>
                            {/* Add an image or video here to visually showcase your company */}
                    ...
                    <Grid.Row>
                        <Grid.Column textAlign='center'>
                            <Link to="/about">
                                <Button primary size='huge'><Icon name='lightbulb outline' size='large' color='white' />Learn More</Button>
                            </Link>
                        </Grid.Column>
                    </Grid.Row>
                </Grid>
            ...
            <Segment basic textAlign='center' style={{ background: '#f5f5f5' }}>
                ...
                <Button primary size='huge' as={Link} to='/contactus'><Icon name='paper plane outline' size='small' color='white'/>Contact Us</Button>
            </Segment>
            ...
            <Segment basic textAlign='center' style={{ background: '#ffffff' }}>
                ...
                <Grid container stackable columns={3} textAlign='center' style={{ marginTop: '2em' }}>
                    ...
                    <Button inverted color='violet' size='huge' as={Link} to='/clients'>See All <Icon name='angle right' size='small' color='white'/></Button>
                </Grid>
            </Segment>

            <Segment basic textAlign='center' style={{ background: '#ffffff' }}>
                <Header as='h2' style={{ fontSize: '2em' }}>See Our Product in Action</Header>
